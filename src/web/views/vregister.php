            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" action="<?php echo site_url('c_register/register'); ?>">
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                ...
                                ?>
                                    ...
                                    <input type="number" name="npm" placeholder="NPM anda" /> 
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">Registrasi</h2> 
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-7 text-center">
                                            <h5>Sudah Yakin? Submit formnya</h5>
